...
public class TestCarWheelPart extends AbstractWheelPart{
    ...
    public static final ResourceLocation PART_MODEL = ResourceLocation.fromNamespaceAndPath(MachineMax.MOD_ID,"entity/mini_ev_wheel");
    public static final ResourceLocation PART_ANIMATION = ResourceLocation.fromNamespaceAndPath(MachineMax.MOD_ID,"entity/mini_ev_wheel.animation");
    public static final ResourceLocation PART_ANI_CONTROLLER = ResourceLocation.fromNamespaceAndPath(MachineMax.MOD_ID,"entity/mini_ev_wheel.animation_controllers");
    //属性参数
    ...
    public TestCarWheelPart(BasicEntity entity) {
        ...
        dgeoms[0].setOffsetQuaternion(DQuaternion.fromEulerDegrees(0,90,0));//默认情况下为左前轮
