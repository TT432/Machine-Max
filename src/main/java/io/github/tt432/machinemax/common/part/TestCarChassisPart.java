...
public class TestCarChassisPart extends AbstractPart {
    ...
    public static final ResourceLocation PART_ANIMATION = ResourceLocation.fromNamespaceAndPath(MachineMax.MOD_ID,"entity/mini_ev_chassis.animation");
    public static final ResourceLocation PART_ANI_CONTROLLER = ResourceLocation.fromNamespaceAndPath(MachineMax.MOD_ID,"entity/mini_ev_chassis.animation_controllers");
    //属性参数
        ...
        for(int i = 0; i < PART_SLOT_NUM; i++){//为车架部件设置四个车轮安装槽
            ...
            switch(i){
                ...
                case 3://右前轮
                    ...
                    break;
                case 4://车壳
                    this.children_parts.set(4,new HullPartSlot(this));
