...
public class SteeringWheelPartSlot extends AbstractPartSlot {
    ...
    public SteeringWheelPartSlot(AbstractPart owner, String locator, DVector3 attachPos, DQuaternion attachRot, double kp, double kd) {
    ...
    protected void attachJoint(AbstractPart part) {
        ...
        ((DHinge2Joint) joints.getFirst()).setParamLoStop(-PI/4);//限制轮胎转角
        ((DHinge2Joint) joints.getFirst()).setParamHiStop(PI/4);
        //设置转向驱动
