...
import static io.github.tt432.machinemax.utils.physics.ode.internal.gimpact.GimGeometry.IDENTIFY_MATRIX_4X4;
...
public abstract class DxTriMesh extends DxMeshBase implements DTriMesh {
    ...
    @SuppressWarnings("deprecation")
    protected DxTriMesh(DxSpace Space, DxTriMeshData Data, DTriCallback Callback,
