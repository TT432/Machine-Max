 ...
 *                                                                       *
 *************************************************************************/
package io.github.tt432.machinemax.util.physics.ode.internal.trimesh;
...
import io.github.tt432.machinemax.util.physics.ode.internal.DBase;
...
import io.github.tt432.machinemax.util.physics.ode.ou.CEnumUnsortedElementArray;

import static io.github.tt432.machinemax.util.physics.ode.DTriMesh.*;
import static io.github.tt432.machinemax.util.physics.ode.DTriMesh.dMESHDATAUSE.*;
import static io.github.tt432.machinemax.util.physics.ode.DTriMeshData.dTRIDATAPREPROCESS_FACE_ANGLES_EXTRA__MAX;
import static io.github.tt432.machinemax.util.physics.ode.DTriMeshData.dTRIDATAPREPROCESS_FACE_ANGLES_EXTRA__MIN;
import static io.github.tt432.machinemax.util.physics.ode.OdeMath.*;
import static io.github.tt432.machinemax.util.physics.ode.internal.Common.M_PI;
import static io.github.tt432.machinemax.util.physics.ode.internal.Common.M_PI_2;
...
//            final EdgeRecord currEdge1 = edges[currEdgeOfs + 1];
    ...
    //    {
    //    &FaceAnglesWrapper<io.github.tt432.machinemax.utils.physics.ode.internal.trimesh.FaceAngleStorageCodec<uint8, SSI_SIGNED_STORED>>::allocateInstance, // ASM_BYTE_SIGNED,
    //    &FaceAnglesWrapper<io.github.tt432.machinemax.utils.physics.ode.internal.trimesh.FaceAngleStorageCodec<uint8, SSI_POSITIVE_STORED>>::allocateInstance, // ASM_BYTE_POSITIVE,
    //    &FaceAnglesWrapper<io.github.tt432.machinemax.utils.physics.ode.internal.trimesh.FaceAngleStorageCodec<uint16, SSI_SIGNED_STORED>>::allocateInstance, // ASM_WORD_SIGNED,
    //    };
    //    END_NAMESPACE_OU();
