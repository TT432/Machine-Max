 ...
 * ----------------------------------------------------------------------------
 */
package io.github.tt432.machinemax.util.physics.ode.internal.gimpact;

import static io.github.tt432.machinemax.util.physics.ode.internal.gimpact.GimGeometry.VEC_ACCUM;
import static io.github.tt432.machinemax.util.physics.ode.internal.gimpact.GimGeometry.VEC_COPY;
import static io.github.tt432.machinemax.util.physics.ode.internal.gimpact.GimGeometry.VEC_DOT;
import static io.github.tt432.machinemax.util.physics.ode.internal.gimpact.GimGeometry.VEC_NORMALIZE;
import static io.github.tt432.machinemax.util.physics.ode.internal.gimpact.GimGeometry.VEC_SCALE;
import static io.github.tt432.machinemax.util.physics.ode.internal.gimpact.GimGeometry.VEC_SUM;
import static io.github.tt432.machinemax.util.physics.ode.internal.gimpact.GimMath.GIM_SQRT;

import io.github.tt432.machinemax.util.physics.ode.internal.cpp4j.java.ObjArray;
import io.github.tt432.machinemax.util.physics.ode.internal.gimpact.GimGeometry.vec3f;
import io.github.tt432.machinemax.util.physics.ode.internal.gimpact.GimGeometry.vec4f;
import io.github.tt432.machinemax.util.physics.ode.internal.gimpact.GimRadixSort.GIM_RSORT_TOKEN;
