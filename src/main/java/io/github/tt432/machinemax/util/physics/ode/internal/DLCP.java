...
import static io.github.tt432.machinemax.util.physics.ode.internal.ErrorHandler.dDebug;
import static io.github.tt432.machinemax.util.physics.ode.internal.ErrorHandler.dMessage;
import static io.github.tt432.machinemax.util.physics.ode.internal.FastLDLTFactor.factorMatrixAsLDLT;
import static io.github.tt432.machinemax.util.physics.ode.internal.FastLDLTSolve.solveEquationSystemWithLDLT;
import static io.github.tt432.machinemax.util.physics.ode.internal.FastLSolve.solveL1Straight;
import static io.github.tt432.machinemax.util.physics.ode.internal.FastLTSolve.solveL1Transposed;
import static io.github.tt432.machinemax.util.physics.ode.internal.Matrix.*;
import static io.github.tt432.machinemax.util.physics.ode.internal.Misc.dClearUpperTriangle;
import static io.github.tt432.machinemax.util.physics.ode.internal.Misc.dMakeRandomMatrix;
import static io.github.tt432.machinemax.util.physics.ode.internal.Misc.dMaxDifference;
import static io.github.tt432.machinemax.util.physics.ode.internal.Misc.dRandReal;
import static io.github.tt432.machinemax.util.physics.ode.internal.cpp4j.Cstdio.printf;
import static io.github.tt432.machinemax.util.physics.ode.internal.cpp4j.Cstring.memcpy;
import static io.github.tt432.machinemax.util.physics.ode.internal.cpp4j.Cstring.memmove;

import io.github.tt432.machinemax.util.physics.math.DMatrixN;
import io.github.tt432.machinemax.util.physics.ode.DStopwatch;
import io.github.tt432.machinemax.util.physics.ode.OdeConfig;
import io.github.tt432.machinemax.util.physics.ode.internal.cpp4j.java.RefDouble;
import io.github.tt432.machinemax.util.physics.ode.internal.processmem.DxUtil;
