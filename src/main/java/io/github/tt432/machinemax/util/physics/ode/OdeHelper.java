 ...
 *                                                                       *
 *************************************************************************/
package io.github.tt432.machinemax.util.physics.ode;
...
import io.github.tt432.machinemax.util.physics.ode.internal.*;
import io.github.tt432.machinemax.util.physics.ode.internal.joints.DxJointConstrainedBall;
import io.github.tt432.machinemax.util.physics.ode.internal.joints.DxJointGroup;
import io.github.tt432.machinemax.util.physics.ode.internal.joints.OdeJointsFactoryImpl;
import io.github.tt432.machinemax.util.physics.ode.internal.ragdoll.DxRagdoll;
import io.github.tt432.machinemax.util.physics.ode.internal.trimesh.DxTriMesh;
import io.github.tt432.machinemax.util.physics.ode.internal.trimesh.DxTriMeshData;
import io.github.tt432.machinemax.util.physics.ode.ragdoll.DRagdoll;
import io.github.tt432.machinemax.util.physics.ode.ragdoll.DRagdollConfig;
import io.github.tt432.machinemax.util.physics.ode.DGeom.DNearCallback;
import io.github.tt432.machinemax.util.physics.ode.DTriMesh.DTriCallback;
import io.github.tt432.machinemax.util.physics.ode.DTriMesh.DTriRayCallback;
...
public abstract class OdeHelper {
	 ...
	 * @return 获得的运动体
	 */
	public static DBody createBody (DWorld world, AbstractPart part){
